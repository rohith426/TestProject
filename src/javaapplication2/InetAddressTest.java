...
public class InetAddressTest {
	...
	public static void main(String[] args) throws Exception {
		...
		InetAddress byIpAsName = InetAddress.getByName("52.65.21.224");
		// Get by IP as highest-order byte array
		InetAddress byIp = InetAddress.getByAddress(new byte[] { 52, 65, 21, (byte)2});
		// Get Local address
...
//		printAddressInfo("Local Host By IP", localByIp);
	...
	private static void printAddressInfo(String name, InetAddress... hosts) throws Exception {
		...
		for(InetAddress host : hosts) {			
			...
			System.out.println("Is Reachable in 2 seconds: " + host.isReachable(5000));
		}
	}
